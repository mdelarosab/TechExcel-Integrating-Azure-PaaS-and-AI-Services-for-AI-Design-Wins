...
{
    // [x] Exercise 5 Task 2 TODO #2: Inject the Kernel service into the MaintenanceCopilot class.
    /// <summary>
    /// The maintenance copilot agent for assisting with maintenance requests.
    /// </summary>
    public class MaintenanceCopilot(Kernel kernel)
    {
        // [x] Exercise 5 Task 2 TODO #3: Uncomment the two lines below to declare the Kernel and ChatHistory objects.
        ...
        private ChatHistory _history = new ("""
            ...
            It is very important that you request aproval before saving the request to the database.
            """);
